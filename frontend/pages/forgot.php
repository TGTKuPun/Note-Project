        ...
        <!-- prettier-ignore -->
          <form class="register-container" id="change_password" method="POST">
            <div class="top">
              <header>Reset Password</header>
              <div class="input-box">
                <input type="password" class="input-field" name="password" id="new-password" placeholder="New Password"/>
                <i class="bx bx-lock-alt"></i>
              </div>
              <div class="input-box">
                <input type="password" class="input-field" name="confirm-password" id="confirm-password" placeholder=" Confirm New Password"/>
                <i class="bx bx-lock-alt"></i>
              </div>
              <div class="input-box">
